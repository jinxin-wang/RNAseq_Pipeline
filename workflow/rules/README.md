...
# 3. [mapping_coverage.smk](https://github.com/jinxin-wang/RNAseq_Pipeline/blob/main/workflow/rules/README.md#mapping_coveragesmk-rule-rseqc_genebody_coverage-mapping-coverage-with-rseqc)

# 4. [transcript_integrity_number.smk](https://github.com/jinxin-wang/RNAseq_Pipeline/blob/main/workflow/rules/README.md#transcript_integrity_numbersmk-rseqc-tin-and-read_duplication)

# 5. [quantify_reads.smk](https://github.com/jinxin-wang/RNAseq_Pipeline/blob/main/workflow/rules/README.md#quantify_readssmk-quantify-reads-per-annotation)

# 6. [kallisto.smk](https://github.com/jinxin-wang/RNAseq_Pipeline/blob/main/workflow/rules/README.md#kallistosmk-quantifying-abundances-of-transcripts-with-kallisto)
